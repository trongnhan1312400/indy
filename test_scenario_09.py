...
async def do():
    ...
    temp = await add_nym(default_trustee_did, trustanchor1_did, trustanchor1_verkey, None, MyVars.roles[4], can_add=True)
    MyVars.test_results["Test 22"] = MyVars.test_results["Test 22"] and temp
    ...
    print(Colors.HEADER + "\t32.  Close pool ledger and wallet\n" + Colors.ENDC)
    try:
